import pygame
from LogicClasses.GreedyFirstSearch_GUI import GreedyFirstSearch_GUI
...
def loadedGreedyFirstSearch(screen,map,startNode,goalNode):
        running = False
        running = True
        ...
        while running:
                ...
                #pygame.display.flip()
                pygame.display.set_caption("Greedy First Search Simulation")
                userText = "testmapGreedy"
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.MOUSEBUTTONDOWN:
                        if event.button == 1:
                            click = True
                            GreedyFirstSearch_GUI(screen,map,startNode,goalNode)