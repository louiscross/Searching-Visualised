import pygame
from LogicClasses.Astar_GUI import AstarAlgorithmGUI
from LogicClasses.BFS_GUI import breadthFirstSearchGUI
from LogicClasses.Dijkstra_GUI import DijkstraGUI
...
def loadedDijkstrasAlgorithm(screen,startNode,endNode):
        running = False
        running = True
        ...
        while running:
                ...
                #pygame.display.flip()
                pygame.display.set_caption("Dijkstra's Algorithm Simulation")
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.MOUSEBUTTONDOWN:
                        if event.button == 1:
                            click = True
                            DijkstraGUI(screen,loadedMap,startNode,endNode)